            ...
            <section className="welcome__container">
                <div className="welcome__content-wrapper">
                    <main className="welcome__main">
                        <article className="welcome__info">
                            <h1 className="welcome__info-header">Let's get started</h1>
                            ...
                            <ul className="welcome__links-list">
                                <li className="welcome__link-item">
                                    <span className="welcome__link-item-icon-wrapper">
                                        <span className="welcome__link-item-icon">
                                            <span className="welcome__link-item-icon-dot" />
                                        </span>
                                    </span>
                                    <span>
                                        Read the
                            ...
                            <ul className="welcome__deploy-list">
                                <li>
                                    <a
                                        href="https://cloud.laravel.com"
                                        target="_blank"
                                        className="welcome__deploy-link"
                                    >
                                        Deploy now
                                    </a>
                                </li>
                        ...
                        <aside className="welcome__logo-container">
                            <svg
                            ...
                            <svg
                                className="welcome__logo-background"
                                viewBox="0 0 440 376"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                            ...
                            <svg
                                className="welcome__logo-background--dark"
                                viewBox="0 0 440 376"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                            ...
                            <div className="welcome__logo-border" />
                        </aside>
                    </main>
                </div>
            </section>
